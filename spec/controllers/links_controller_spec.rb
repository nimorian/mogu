  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved link as @link" do
        ...
        post :create, {:link => { "page_id" => "invalid value" }}, valid_session
        assigns(:link).should be_a_new(Link)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested link" do
        ...
        Link.any_instance.should_receive(:update).with({ "page_id" => "1" })
        put :update, {:id => link.to_param, :link => { "page_id" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the link as @link" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Link.any_instance.stub(:save).and_return(false)
        put :update, {:id => link.to_param, :link => { "page_id" => "invalid value" }}, valid_session
        assigns(:link).should eq(link)
      end
